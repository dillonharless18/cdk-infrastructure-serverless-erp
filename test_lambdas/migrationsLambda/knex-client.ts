...
const RDS_DB_PASS_SECRET_ID = process.env.RDS_DB_PASS_SECRET_ID || 'TEST'
const RDS_DB_NAME = process.env.RDS_DB_NAME || 'TEST'
const RDS_DB_SCHEMA = process.env.RDS_DB_SCHEMA || 'TEST'
