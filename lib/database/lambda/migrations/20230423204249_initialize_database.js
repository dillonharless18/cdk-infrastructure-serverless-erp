...
export async function up(knex) {
  ...
  await knex.schema.createTable('vendor', function(table) {
    ...
    table.boolean('is_active').notNullable();
    table.string('created_by', 36).notNullable().references('user_id').inTable('user');
    table.string('last_updated_by', 36).notNullable().references('user_id').inTable('user');
    table.dateTime('created_at').notNullable();
    table.dateTime('last_updated_at').notNullable();
  ...
  await knex.schema.createTable('urgent_order_status', function(table) {
    ...
    table.boolean('is_active').notNullable();
    table.string('created_by', 36).notNullable().references('user_id').inTable('user'); // TODO typo here in schema, "create_by"
    table.string('last_updated_by', 36).notNullable().references('user_id').inTable('user');
    table.dateTime('created_at').notNullable();
    table.dateTime('last_updated_at').notNullable();
  });
  ...
  await knex.schema.createTable('transportation_trip', function(table) {
    table.string('transportation_trip_id', 36).notNullable().primary();
    table.string('driver_id', 36).notNullable().references('user_id').inTable('user');
    table.string('created_by', 36).notNullable().references('user_id').inTable('user');
    table.string('last_updated_by', 36).notNullable().references('user_id').inTable('user');
    table.dateTime('created_at').notNullable();
    table.dateTime('last_updated_at').notNullable();
  ...
  await knex.schema.createTable('purchase_order_request_item', function(table) {
    table.string('purchase_order_request_item_id', 36).notNullable().primary();
    table.string('last_updated_by', 36).notNullable().references('user_id').inTable('user');
    table.string('created_by', 36).notNullable().references('user_id').inTable('user');
  ...
  await knex.schema.createTable('purchase_order', function(table) {
    table.string('purchase_order_id', 36).notNullable().primary();
    table.string('created_by', 36).notNullable().references('user_id').inTable('user');
    table.string('last_updated_by', 36).notNullable().references('user_id').inTable('user');
    table.dateTime('created_at').notNullable();
    table.dateTime('last_updated_at').notNullable();
  ...
  await knex.schema.createTable('ocr_imported_purchase_order_draft', function(table) {
    table.string('ocr_imported_purchase_order_draft_id', 36).notNullable().primary();
    table.string('created_by', 36).notNullable().references('user_id').inTable('user');
    table.integer('vendor_id').notNullable().references('vendor_id').inTable('vendor');
    table.string('last_updated_by', 36).notNullable().references('user_id').inTable('user');
    table.dateTime('created_at').notNullable();
  ...
  await knex.schema.createTable('item_transportation_request', table => {
    table.string('item_transportation_request_id', 36).notNullable().primary();
    table.string('last_updated_by', 36).notNullable();
  ...
  await knex.schema.createTable('transportation_trip_comment', (table) => {
    table.string('transportation_trip_comment_id', 36).primary();
    table.string('transportation_trip_id', 36).notNullable();
    table.string('created_by', 36).notNullable().references('user_id').inTable('user');
    table.datetime('created_at').notNullable();
  ...
  await knex.schema.createTable('transportation_trip_by_item_transportation_request', table => {
    table.string('item_transportation_request_id', 36).notNullable();
    table.string('transportation_trip_id', 36).notNullable();
    table.integer('transportation_request_status_id').notNullable();
    table.string('last_updated_by', 36).notNullable();
    table.string('created_by', 36).notNullable();
  ...
  await knex.schema.createTable('purchase_order_transportation_request', function(table) {
    table.string('purchase_order_transportation_request_id', 36).notNullable().primary();
    table.string('purchase_order_id', 36).notNullable();
    table.string('last_updated_by', 36).notNullable();
    table.string('transportation_request_type_id', 25).notNullable();
    table.string('created_by', 36).notNullable();
    table.string('from_location', 100).notNullable();
  ...
  await knex.schema.createTable('purchase_order_request_item_comment', function(table) {
    table.string('purchase_order_request_item_comment_id', 36).notNullable().primary();
    table.string('purchase_order_request_item_id', 36).notNullable().references('purchase_order_request_item.purchase_order_request_item_id');
    table.string('created_by', 36).notNullable().references('user.user_id');
    table.string('comment_text', 100).notNullable();
    table.datetime('created_at').notNullable();
  })
  ...
  await knex.schema.createTable('purchase_order_item', function(table) {
    table.string('purchase_order_item_id', 36).notNullable();
    table.string('purchase_order_id', 36).notNullable();
    table.string('created_by', 36).notNullable();
    table.string('last_updated_by', 36).notNullable();
    table.string('price', 15).notNullable();
  ...
  await knex.schema.createTable('purchase_order_comment', function(table) {
    table.string('purchase_order_comment_id', 36).notNullable().primary();
    table.string('purchase_order_id', 36).notNullable().references('purchase_order_id').inTable('purchase_order');
    table.string('created_by', 36).notNullable().references('user_id').inTable('user');
    table.datetime('created_at').notNullable();
    table.string('comment_text', 100).notNullable();
  });
  ...
  await knex.schema.createTable('ocr_purchase_order_draft_by_created_purchase_order', table => {
    table.string('ocr_imported_purchase_order_draft_id', 36).notNullable();
    table.string('purchase_order_id', 36).notNullable();
  ...
  await knex.schema.createTable('ocr_imported_purchase_order_draft_item', table => {
    table.string('ocr_imported_purchase_order_draft_item_id', 36).notNullable().primary();
    table.string('ocr_imported_purchase_order_draft_id', 36).notNullable().references('ocr_imported_purchase_order_draft.ocr_imported_purchase_order_draft_id');
    table.string('created_by', 36).notNullable().references('user.user_id');
    table.string('last_updated_by', 36).notNullable().references('user.user_id');
    table.string('item_name', 45).notNullable();
  ...
  await knex.schema.createTable('ocr_imported_purchase_order_draft_comment', function(table) {
    table.string('ocr_imported_purchase_order_draft_comment_id', 36).notNullable().primary();
    table.string('ocr_imported_purchase_order_draft_id', 36).notNullable().references('ocr_imported_purchase_order_draft.ocr_imported_purchase_order_draft_id');
    table.string('created_by', 36).notNullable().references('user.user_id');
    table.datetime('created_at').notNullable();
    table.string('comment_text', 100).notNullable();
  ...
  await knex.schema.createTable('item_transportation_request_comment', function(table) {
    table.string('item_transportation_request_comment_id', 36).notNullable().primary();
    table.string('item_transportation_request_id', 36).notNullable().references('item_transportation_request.item_transportation_request_id').onDelete('CASCADE');
    table.string('created_by', 36).notNullable().references('user.user_id').onDelete('CASCADE');
    table.string('comment_text', 100).notNullable();
    table.datetime('created_at').notNullable();
  });
  ...
  await knex.schema.createTable('transportation_trip_by_purchase_order_transportation_request', function(table) {
    table.string('purchase_order_transportation_request_id', 36).notNullable();
    table.string('transportation_trip_id', 36).notNullable();
    table.integer('transportation_request_status_id').notNullable();
    table.string('last_updated_by', 36).notNullable();
    table.string('created_by', 36).notNullable();
  ...
  await knex.schema.createTable('purchase_order_transportation_request_comment', function(table) {
    table.string('purchase_order_transportation_request_comment_id', 36).notNullable().primary();
    table.string('purchase_order_transportation_request_id', 36).notNullable().references('purchase_order_transportation_request_id').inTable('purchase_order_transportation_request');
    table.string('created_by', 36).notNullable().references('user_id').inTable('user');
    table.datetime('created_at').notNullable();
    table.string('comment_text', 100).notNullable();
  });
  ...
  await knex.schema.createTable('ocr_imported_purchase_order_draft_item_by_purchase_order_item', table => {
    ...
    // table.string('purchase_order_item_id', 36).notNullable().references('purchase_order_item_id').inTable('purchase_order_item').onDelete('CASCADE');
    table.string('purchase_order_item_id', 36).notNullable();
    // table.string('ocr_imported_purchase_order_draft_item_id', 36).notNullable().references('ocr_imported_purchase_order_draft_item_id').inTable('ocr_imported_purchase_order_draft_item').onDelete('CASCADE');
    table.string('ocr_imported_purchase_order_draft_item_id', 36).notNullable();
