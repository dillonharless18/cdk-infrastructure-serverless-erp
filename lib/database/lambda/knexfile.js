...
RDS_DB_PASS_SECRET_ID = process.env.RDS_DB_PASS_SECRET_ID;
RDS_DB_NAME = process.env.RDS_DB_NAME;
RDS_DB_SCHEMA = process.env.RDS_DB_SCHEMA;
...
async function getSecretValue(secretId) {
  const data = await secretsManagerClient.getSecretValue({ SecretId: secretId });
