import OcrImportedPurchaseOrderDraft from "../../../event-consumer/DTO/OcrImportedPurchaseOrderDraft.js";
import VeryfiUtil from "../../../event-consumer/veryfi-util.js";

jest.mock("../../../event-consumer/node_modules/@aws-sdk/client-s3", () => ({
    S3Client: jest.fn().mockImplementation(() => ({
        send: jest.fn(() => "https://bucket.s3.amazonaws.com/key"),
    })),
    PutObjectCommand: jest.fn().mockImplementation((data) => data),
}));
jest.mock("../../../event-consumer/node_modules/node-fetch", () => jest.fn());
...
describe("OcrImportedPurchaseOrderDraft", () => {
    ...
    VeryfiUtil.isValidNumber.mockImplementation(() => true);
    VeryfiUtil.formatStringWithMaxLength.mockImplementation((str) => str);
    VeryfiUtil.isValidString.mockImplementation(() => true);
