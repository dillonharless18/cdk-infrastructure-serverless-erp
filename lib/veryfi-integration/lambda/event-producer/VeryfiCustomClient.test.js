...
const ActualClientMock =
    require("./__mocks__/@veryfi/veryfi-sdk/lib/main.js").default;

jest.mock("@veryfi/veryfi-sdk/lib/main.js", () => {
    const ActualClientMock =
        require("./__mocks__/@veryfi/veryfi-sdk/lib/main.js").default;
    return ActualClientMock;
});
...
describe("VeryfiCustomClient", () => {
    ...
    beforeEach(() => {
        ...
        ActualClientMock.prototype._request = jest.fn();
    ...
    describe("getDocumentsCreatedWithinRangeEmptyReponse", () => {
        it("should call the _request method with correct arguments and empty response", async () => {
            ActualClientMock.prototype._request.mockResolvedValue({
                data: { documents: [] },
            });

            const output = await client.getDocumentsCreatedWithinRange(2, 1);

            expect(ActualClientMock.prototype._request).toHaveBeenCalledWith(
                "GET",
        ...
        it("should call the _request method with correct arguments and undefined response", async () => {
            ActualClientMock.prototype._request.mockResolvedValue(undefined);
