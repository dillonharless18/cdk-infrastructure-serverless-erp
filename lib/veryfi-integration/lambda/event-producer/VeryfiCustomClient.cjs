...
class VeryfiCustomClient extends Client {
    ...
    async getDocumentsCreatedWithinRange(
        ...
        try {
            console.log(
                `getDocumentsCreatedWithinRange: upper limit time delta = ${upperLimitTimeDelta}`
            );
            console.log(
                `getDocumentsCreatedWithinRange: lower limit time delta = ${lowerLimitTimeDelta}`
            );
            const created__gte =
            ...
            console.log(
                `getDocumentsCreatedWithinRange: created__gte = ${created__gte}`
            );
            console.log(
                `getDocumentsCreatedWithinRange: created__lte = ${created__lte}`
            );
