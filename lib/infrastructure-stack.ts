...
export class InfrastructureStack extends Stack {
    ...
    constructor(
        ...
        const api = new ApiConstruct(this, "ApiStack", {
            ...
            ingressQueue: extensibleFinanceModule.ingressQueue
                ? extensibleFinanceModule.ingressQueue
                : null,
            egressQueue: extensibleFinanceModule.egressQueue
                ? extensibleFinanceModule.egressQueue
                : null,
        });
        ...
        this.crossAccountLambdaInvokeRoleName =
            migrationsLambda.crossAccountLambdaInvokeRoleName;
        ...
        const veryfi = new VeryfiIntegrationConstruct(
            this,
            "VerifyIntegration",
            {
                env: props.env,
                ...
                assetBucket: cognito.oneXerpAssetsBucket,
            }
        );
    }
}
